...
❗ ③ 内容包**只放小红书内容**(5 条标题钩子 + N 篇小红书正文 + 3-5 条卖点弹药),**绝不要媒体通稿 / 新闻稿 / 邮件 / 危机预案**,**也绝不要任何排期表 / 时间线 / T-XX / W-XX / 周次安排**——排期是 ⑤(下一轮)的唯一职责,这一轮(①-④)里不许出现任何排期表。
...
❗ **你的输出第一行必须正好是 \`## ⑤ 营销排期日历\`**(逐字,不要改名、不要加别的前缀),否则前端会把它错放到内容包里。
